...
# API access token — used by APITokenMiddleware (empty = no enforcement)
API_ACCESS_TOKEN = os.getenv("API_ACCESS_TOKEN", "")

# ---------------------------------------------------------------------------
# Celery configuration (optional — only used when Celery is installed locally)
# ---------------------------------------------------------------------------
try:
    ...
    # Celery not installed (e.g. production on Fly.io) — skip
    pass
